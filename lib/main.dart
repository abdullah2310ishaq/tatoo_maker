...
class _MyAppState extends State<MyApp> with WidgetsBindingObserver {
  ...
  void didChangeAppLifecycleState(AppLifecycleState state) {
    // Ignore lifecycle noise generated by App Open ad fullscreen transitions.
    if (_appOpenAdService.isShowing) {
      if (kDebugMode) {
        debugPrint('[AppOpen] lifecycle ignored while ad is showing: $state');
      }
      return;
    }
  ...
  Future<void> _maybeShowAppOpenAdOnResume() async {
    if (_resumeCheckInProgress) {
      if (kDebugMode) {
        debugPrint('[AppOpen] skip: resume check already in progress');
      }
      return;
    }
